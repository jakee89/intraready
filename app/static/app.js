...
document.addEventListener("click", async event => {
  ...
  if (rereadLocal) {
    ...
    try { state.currentInvoice = await api(`/api/invoices/${state.currentInvoice.id}/extract-again?use_ai=false`, { method: "POST" }); await refreshBootstrap(); renderReview(); toast("Invoice re-read locally — no API credits used"); }
