...
BOOTSTRAP_TOKEN = os.getenv("INTRASTAT_BOOTSTRAP_TOKEN", "") or APP_PASSWORD
...
AUTH_COOKIE_SECURE = os.getenv("INTRASTAT_AUTH_COOKIE_SECURE", "false").lower() in {"1", "true", "yes"}
