...
plain decimal strings, and one line per source product or charge. Do not guess missing values. Invoice value is the
line's extended total, not unit price. net_mass is total row kg; unit_net_mass is kg per unit. Use source page markers.
